...
mod test_nitro_cli_args {
    ...
    fn build_signed_enclave_correct_command_http_signing() {
        ...
        let args = vec![
            ...
            "cert.pem",
            "--private-key",
            "https://signing.example.com/v2/core/sign/ecdsa-sha256",
        ];
    ...
    fn build_signed_enclave_correct_command_http_signing_with_mtls() {
        ...
        let args = vec![
            ...
            "cert.pem",
            "--private-key",
            "https://signing.example.com/v2/core/sign/ecdsa-sha256;client_cert=/path/to/client.crt;client_key=/path/to/client.key",
        ];
